...
export async function createWorkshopBookingDraft(bookingData) {
  try {
    ...
    // 1. Check if workshop exists and has space
    ...
    const draftBooking = {
      ...
      workshopTitle: workshop.title, // Take title directly from DB for safety
    ...
    // Return the ID so the UI can pass it to Step 2
