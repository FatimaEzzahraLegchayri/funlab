import { firebaseLogin, firebaseSignup } from '../firebase/auth';
...
export async function signup(name, email, password, role = 'admin') {
  try {
    console.log('Signing up user:', name, email, password, role);
    ...
    console.log('User document reference:', user.uid, name, email, password, role);
